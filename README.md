...
"""
```
* Womi preferred(http://video.51wom.com/)

### TODO:
* Inke (http://www.inke.cn/hotlive_list.html)
* Douyu (https://www.douyu.com/)
* WeChat public account

### Please refer to the following article for code logic:
#####[Python web crawler for beginners](http://mp.weixin.qq.com/s/vNcQtXWjGHnc6JMjt_vWiQ "Python web crawler for beginners")
#####[Web crawler for Python beginners (2)](http://mp.weixin.qq.com/s/WoLKDnaFBcJ-u3msAqtDNw "Web crawler for Python beginners (2)")
